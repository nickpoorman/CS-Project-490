			...
			if (c.getUserName().equals(userName)) {
				...
				for (int i = 1; i < inputs.length; ++i) {
					if (inputs[i].equalsIgnoreCase("Curse")) {
						if (currentCharacter.getMana() < 20) {
							out.println("Not enough mana to do curse! Must have at least 20 mana but you only have " + currentCharacter.getMana());
							return;
						}
						else {
